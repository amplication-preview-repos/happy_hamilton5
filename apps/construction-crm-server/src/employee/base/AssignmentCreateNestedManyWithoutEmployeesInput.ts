...
@InputType()
class AssignmentCreateNestedManyWithoutEmployeesInput {
...
export { AssignmentCreateNestedManyWithoutEmployeesInput as AssignmentCreateNestedManyWithoutEmployeesInput };
