  ...
  test("POST /customers", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastContactedDate: CREATE_RESULT.lastContactedDate.toISOString(),
      ...
      .expect([
        {
          ...
          lastContactedDate:
            FIND_MANY_RESULT[0].lastContactedDate.toISOString(),
  ...
  test("GET /customers/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastContactedDate: FIND_ONE_RESULT.lastContactedDate.toISOString(),
